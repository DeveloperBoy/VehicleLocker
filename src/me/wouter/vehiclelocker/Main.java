...
public class Main extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        if (Bukkit.getPluginManager().isPluginEnabled("VehiclesPlusLite")) {
            getLogger().severe(color("&3VehiclesPlus Lite &bv" + Bukkit.getPluginManager().getPlugin("VehiclesPlusLite").getDescription().getVersion() + " &3found! Hooking.."));
            vehiclesPlusPlugin = true;

            Bukkit.getPluginManager().registerEvents(new VehiclesPlusPluginListener(), this);
        } else if (Bukkit.getPluginManager.isPluginEnabled("VehiclesPlusPro")) {
            getLogger().severe(color("&3VehiclesPlus Pro &bv" + Bukkit.getPluginManager().getPlugin("VehiclesPlusPro").getDescription().getVersion() + " &3found! Hooking.."));
            vehiclesPlusPlugin = true;
